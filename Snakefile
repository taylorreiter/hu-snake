...
rule all:
    input:
        ...
        dynamic('outputs/hu-crumbs_bin/unitigs/prokka-all/{crumb_bin}.faa'),
        #dynamic('outputs/hu-crumbs_gold/subtracts/prokka-all/{crumb_bin}.faa'),
        dynamic('outputs/hu-crumbs_bin/assembly/prokka/{crumb_bin}.faa'),
        # KEGG targets        
